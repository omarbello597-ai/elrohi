...
function printRemisionTinto(lot, satName, remData) {
  ...
  <div style="max-width:900px;margin:12px auto;border:1.5px solid #14405A">
    <div style="border-bottom:2px solid #1a3a6b;padding:10px 16px;display:flex;align-items:center;justify-content:space-between;gap:12px">
      <div style="display:flex;align-items:center;gap:10px;flex:1"><img src="https://i.ibb.co/nMgfFVH0/Logo-ELROHI.jpg" style="height:54px;width:auto;object-fit:contain" /><div><div style="font-size:18px;font-weight:900"><span style="color:#2878B4">Dotaciones </span><span style="color:#14405A">EL·ROHI</span></div><div style="font-size:9px;color:#14405A;margin-top:2px">NIT. 901.080.234-7 · Calle 39 A Sur No. 5-63 Este La Victoria · Cel.: 313 372 5739</div></div></div>
